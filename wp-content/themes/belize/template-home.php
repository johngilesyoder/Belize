    ...
    <div class="row">
      <div class="col-md-3">
        <div class="main-feature">
          ...
          <h3>Location</h3>
          <p>
            Exotic private island in Glover’s Reef Atoll on Belize’s Barrier Reef—the most remote and unspoiled atoll in Belize and a designated UNESCO World Heritage Site.
          </p>
        </div>
      </div>
      <div class="col-md-3">
        <div class="main-feature">
          ...
          <h3>Activities</h3>
          <p>
            All inclusive, guided tour packages including: sea and surf kayaking, surfing, paddle-boarding, kite and wind surfing, snorkeling, scuba diving, kayak fishing and rainforest and archeological trips to the mainland.
          </p>
        </div>
      </div>
      <div class="col-md-3">
        <div class="main-feature">
          ...
          <h3>Business</h3>
          <p>
            This highly reputable and profitable turnkey adventure travel business was the first sea kayak outfitter in Belize and has been in operation for 38 years.
          </p>
        </div>
      </div>
      <div class="col-md-3">
...
<section id="location" class="section-location">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <p>
          This turnkey adventure travel business is based on an exotic 13.6-acre private island and is one of five islands found at Glover’s Reef Atoll, the most remote and unspoiled atoll in Belize. The business includes 5.3 acres on the windward side of the island bordered both by the open Caribbean to the southeast and a quiet lagoon to the northwest. Glover’s Reef is part of the most famous of Belize’s natural attractions, the Barrier Reef, which stretches in a line 20 to 25 miles offshore for nearly the entire length of the country. The reef is studded with idyllic tropical islands, with the offshore atolls enclosing the most pristine of the reefs found in the country, including the internationally known Blue Hole.
        </p>
        <p>
          The atoll encompasses one of Belize’s protected National Marine Reserves, and has been recognized for its outstanding beauty and pristine condition as a designated UNESCO World Heritage Site. The surrounding reefs, open Caribbean sea, and palm covered beaches rival any tropical island in the Caribbean. Belize is world famous for its scuba diving and pristine barrier reef. It is a truly world class location and boasts the best coral reefs in the western hemisphere.
        </p>
      </div>
      <div class="col-sm-6">
        <div id="bubbles" class="bubbles">
          ...
          <aside id="bubbles-aside" class="aside-desktop">
            <p>
              <strong>GLOVER’S REEF ATOLL</strong> &mdash; The atoll encompasses one of Belize’s protected National Marine Reserves, and has been recognized for its outstanding beauty and pristine condition as a designated UNESCO World Heritage Site.
            </p>
          </aside>
        </div>
...
<section id="business" class="section-business">
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-6">
        <p>
          This highly reputable and profitable adventure travel business was the first sea kayak outfitter in Belize. It has been in operation since 1977 and grosses over $1M per year. The company has maintained a reputation for high quality trips and innovative itineraries. The business includes the 5.3-acre island resort and a 4-bed, 3-bath house office in Belize City in an upscale neighborhood on a canal network one block from the ocean. The building serves as staff quarters, storage for equipment, vehicles and dock for our shuttle boat. Other assets include a 41’ shuttle boat, vehicle fleet for our trips, 37 sea kayaks, 10 surf kayaks, 4 fishing kayaks, 6 surfboards, 13 paddleboards, 14 windsurf rigs, and a fully equipped kite school with 8 kite set ups. All reservations and record keeping are processed through the head office in Moab, Utah. Support staff includes: office managers, local guides, cooks, maintenance and groundskeepers, and local captains and drivers.
        </p>
      </div>
      <div class="col-md-6">
        <p>
    ...
    <div class="row">
      <div class="col-md-10">
        <div class="primary-section">
          ...
          <p>
            According to the Wildlife Conservation Society, "The Belize Barrier reef is one of the world’s outstanding barrier reef systems, containing a necklace of three offshore atolls, hundreds of sand cays and patch reefs, mangrove forests, coastal lagoons, estuaries and a thriving ecosystem comprised of approximately 500 species of fish, 134 bird species, three varieties of nesting sea turtles, and one of the largest populations of West Indian Manatees." Glover's harbors one of the greatest diversity of reef types in the western Caribbean and is considered one of the highest priority areas in the Mesoamerican reef system. Species frequently seen include iguana, geckos, a variety of dolphins, stingrays, turtles, sharks, eels, grunts, wrasse, bone fish, snapper, angel fish, and many other fish species.  Osprey, falcons, herons, nighthawks, flycatchers, warblers, swallows are just some of the bird species found at Glover’s Reef.
          </p>
        </div>
      </div>
    </div>
